...
function Footer() {
    ...
    return (
        <footer className="bg-[#234F3D] py-10">
            <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 text-center md:flex-row md:justify-between md:text-left">
               ...
               <ul className="flex flex-wrap justify-center gap-6">
                {quickLinks.map((link) => (
                    <li key={link.label}>
                        <a href={link.href} className="text-sm text-[#F8F3E8]/70 transition hover:text-[#C89B3C]">
                            {link.label}
                        </a>
                    </li>
                ))}
                ...
                <div className="flex gap-4">
                    <a href="#" aria-label="Facebook" className="text-[#F8F3E8]/70 hover:text-[#C89B3C]">
                    ...
                    <a href="#" aria-label="Instagram" className="text-[#F8F3E8]/70 hover:text-[#C89B3C]">
                        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <p className="mt-6 text-center text-xs text-[#F8F3E8]/40">
                © {year} Lasalin. All rights reserved.
            </p>
        </footer>
    );
}
