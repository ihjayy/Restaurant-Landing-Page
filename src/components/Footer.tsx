        ...
        <footer className="bg-[#120D0A] py-10">
            <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 text-center md:flex-row md:justify-between md:text-left">
               ...
               <ul className="flex flex-wrap justify-center gap-6">
                {quickLinks.map((link) => (
                    <li key={link.label}>
                        <a href={link.href} className="text-sm text-[#F5EDE0]/70 transition hover:text-[#D4A017]">
                            {link.label}
                        </a>
                    </li>
                ))}
                ...
                <div className="flex gap-4">
                    <a href="#" aria-label="Facebook" className="text-[#F5EDE0]/70 hover:text-[#D4A017]">
                    ...
                    <a href="#" aria-label="Instagram" className="text-[#F5EDE0]/70 hover:text-[#D4A017]">
                        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
